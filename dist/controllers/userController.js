...
const create_user = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingUser = yield (0, db_methods_1.read_function)("User", "findOne", { where: { email: req.body.email } });
        if (existingUser) {
        ...
        const newUser = yield (0, db_methods_1.insert_function)("User", "create", userData);
        const token = jsonwebtoken_1.default.sign({ email }, JWT_SECRET, { expiresIn: '10m' });
...
const get_all_users = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const allUsers = yield (0, db_methods_1.read_function)("User", "findAll");
...
const get_user_by_id = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield (0, db_methods_1.read_function)("User", "findOne", { where: { id: req.params.id } });
        if (!user) {
...
const update_user = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedUser = yield (0, db_methods_1.insert_function)("User", "update", req.body, { where: { id: req.params.id } });
...
const delete_user = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, db_methods_1.read_function)("User", "destroy", { where: { id: req.params.id } });
...
const approve_user = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield (0, db_methods_1.read_function)("User", "findOne", { where: { id: req.params.id } });
        if (!user) {
            res.status(404).json({ message: "User not found" });
        ...
        const approvedUser = yield (0, db_methods_1.insert_function)("User", "update", { approvalStatus: true }, { where: { id: req.params.id } });
...
const disapprove_user = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield (0, db_methods_1.read_function)("User", "findOne", { where: { id: req.params.id } });
        if (!user) {
            res.status(404).json({ message: "User not found" });
        ...
        const disapprovedUser = yield (0, db_methods_1.insert_function)("User", "update", { approvalStatus: false }, { where: { id: req.params.id } });
...
const get_approved_users = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const approvedUsers = yield (0, db_methods_1.read_function)("User", "findAll", { where: { approvalStatus: true } });
...
const get_unapproved_users = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const unapprovedUsers = yield (0, db_methods_1.read_function)("User", "findAll", { where: { approvalStatus: false } });
...
const verify_otp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, db_methods_1.insert_function)("User", "update", { isVerified: true, otp: null, otpExpires: null }, { where: { email } });
...
const resend_otp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, db_methods_1.insert_function)("User", "update", { otp: newOtp, otpExpires, lastOtpSent: new Date(now) }, { where: { email } });
